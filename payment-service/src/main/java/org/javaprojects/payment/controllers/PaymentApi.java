...
public interface PaymentApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Payment information This will return true if the payment was successful, false otherwise. ", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = UpdateBalanceResponse.class))
            }),
    ...
    default Mono<ResponseEntity<UpdateBalanceResponse>> makePayment(
        @Parameter(name = "amount", description = "Amount to be paid", required = true, in = ParameterIn.PATH) @PathVariable("amount") Float amount,
